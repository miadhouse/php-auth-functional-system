/*! odometer 0.4.8 */
(function () {
    var t, e, n, i, o, r, s, a, u, d, l, h, p, c, m, f, g, v, w, M, y = [].slice;
    t = /^\(?([^)]*)\)?(?:(.)(d+))?$/, e = 1e3 / 30, p = document.createElement("div").style, o = null != p.transition || null != p.webkitTransition || null != p.mozTransition || null != p.oTransition, l = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, n = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, s = function (t) {
        ...
        var t, e, n, i, o;
        if (!g && null != window.jQuery) {
            for (g = !0, o = [], e = 0, n = (i = ["html", "text"]).length; n > e; e++) t = i[e], o.push(function (t) {
                var e;
        ...
        function i(t) {
            var n, o, r, s, a, u, d, l, h, p = this;
            if (this.options = t, this.el = this.options.el, null != this.el.odometer) return this.el.odometer;
            for (n in this.el.odometer = this, d = i.options) r = d[n], null == this.options[n] && (this.options[n] = r);
            null == (s = this.options).duration && (s.duration = 2e3), this.MAX_VALUES = this.options.duration / e / 2 | 0, this.resetFormat(), this.value = this.cleanValue(null != (l = this.options.value) ? l : ""), this.renderInside(), this.render();
            try {
                for (a = 0, u = (h = ["innerHTML", "innerText", "textContent"]).length; u > a; a++) o = h[a], null != this.el[o] && function (t) {
        ...
        return i.prototype.renderInside = function () {
            ...
            var t = this;
            if (null != n) try {
                return null == this.observer && (this.observer = new n((function (e) {
                    var n;
            ...
            var e;
            return "string" == typeof t && (t = (t = (t = t.replace(null != (e = this.format.radix) ? e : ".", "<radix>")).replace(/[.,]/g, "")).replace("<radix>", "."), t = parseFloat(t, 10) || 0), h(t, this.format.precision)
            ...
            if (!this.transitionEndBound) {
                for (this.transitionEndBound = !0, e = !1, r = [], n = 0, i = (o = "transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd".split(" ")).length; i > n; n++) t = o[n], r.push(this.el.addEventListener(t, (function () {
                    return e || (e = !0, setTimeout((function () {
                        return s.render(), e = !1, c(s.el, "odometerdone")
                    }), 0)), !0
                }), !1));
                return r
            }
            ...
            var e, n, i, r, s, a, u;
            for (null == t && (t = this.value), this.stopWatchingMutations(), this.resetFormat(), this.inside.innerHTML = "", s = this.options.theme, r = [], a = 0, u = (e = this.el.className.split(" ")).length; u > a; a++) (n = e[a]).length && ((i = /^odometer-theme-(.+)$/.exec(n)) ? s = i[1] : /^odometer(-|$)/.test(n) || r.push(n));
            return r.push("odometer"), o || r.push("odometer-no-transitions"), s ? r.push("odometer-theme-" + s) : r.push("odometer-auto-theme"), this.el.className = r.join(" "), this.ribbons = {}, this.formatDigits(t), this.startWatchingMutations()
        }, i.prototype.formatDigits = function (t) {
            var e, n, i, o, r, s, u, d, l;
            if (this.digits = [], this.options.formatFunction) for (o = 0, s = (d = this.options.formatFunction(t).split("").reverse()).length; s > o; o++) (n = d[o]).match(/0-9/) ? ((e = this.renderDigit()).querySelector(".odometer-value").innerHTML = n, this.digits.push(e), this.insertDigit(e)) : this.addSpacer(n); else for (i = !this.format.precision || !a(t) || !1, r = 0, u = (l = t.toString().split("").reverse()).length; u > r; r++) "." === (e = l[r]) && (i = !0), this.addDigit(e, i)
        }, i.prototype.update = function (t) {
            var e, n = this;
            return (e = (t = this.cleanValue(t)) - this.value) ? (d(this.el, "odometer-animating-up odometer-animating-down odometer-animating"), r(this.el, e > 0 ? "odometer-animating-up" : "odometer-animating-down"), this.stopWatchingMutations(), this.animate(t), this.startWatchingMutations(), setTimeout((function () {
                return n.el.offsetHeight, r(n.el, "odometer-animating")
        ...
        }, i.prototype.addSpacer = function (t, e, n) {
            var i;
            return (i = s('<span class="odometer-formatting-mark"></span>')).innerHTML = t, n && r(i, n), this.insertDigit(i, e)
            ...
            if (n = +t - this.value) return o = i = u(), e = this.value, (r = function () {
                var a, d;
                return u() - o > s.options.duration ? (s.value = t, s.render(), void c(s.el, "odometerdone")) : ((a = u() - i) > 50 && (i = u(), d = a / s.options.duration, e += n * d, s.render(Math.round(e))), null != l ? l(r) : setTimeout(r, 50))
            })()
        }, i.prototype.getDigitCount = function () {
            var t, e, n, i, o, r;
            for (t = o = 0, r = (i = 1 <= arguments.length ? y.call(arguments, 0) : []).length; r > o; t = ++o) n = i[t], i[t] = Math.abs(n);
            return e = Math.max.apply(Math, i), Math.ceil(Math.log(e + 1) / Math.log(10))
        }, i.prototype.getFractionalDigitCount = function () {
            var t, e, n, i, o, r, s;
            for (e = /^\-?\d*\.(\d*?)0*$/, t = r = 0, s = (o = 1 <= arguments.length ? y.call(arguments, 0) : []).length; s > r; t = ++r) i = o[t], o[t] = i.toString(), n = e.exec(o[t]), o[t] = null == n ? 0 : n[1].length;
            return Math.max.apply(Math, o)
        }, i.prototype.resetDigits = function () {
            return this.digits = [], this.ribbons = [], this.inside.innerHTML = "", this.resetFormat()
        }, i.prototype.animateSlide = function (t) {
            var e, n, i, o, s, a, u, d, l, h, p, c, f, g, v, w, M, y, b, T, E, x, S, D, L, F, A;
            if (w = this.value, (d = this.getFractionalDigitCount(w, t)) && (t *= Math.pow(10, d), w *= Math.pow(10, d)), i = t - w) {
                for (this.bindTransitionEnd(), o = this.getDigitCount(w, t), s = [], e = 0, p = b = 0; o >= 0 ? o > b : b > o; p = o >= 0 ? ++b : --b) {
                    if (M = m(w / Math.pow(10, o - p - 1)), a = (u = m(t / Math.pow(10, o - p - 1))) - M, Math.abs(a) > this.MAX_VALUES) {
                        for (h = [], c = a / (this.MAX_VALUES + this.MAX_VALUES * e * .5), n = M; a > 0 && u > n || 0 > a && n > u;) h.push(Math.round(n)), n += c;
                ...
                for (this.resetDigits(), p = E = 0, S = (F = s.reverse()).length; S > E; p = ++E) for (h = F[p], this.digits[p] || this.addDigit(" ", p >= d), null == (y = this.ribbons)[p] && (y[p] = this.digits[p].querySelector(".odometer-ribbon-inner")), this.ribbons[p].innerHTML = "", 0 > i && (h = h.reverse()), f = L = 0, D = h.length; D > L; f = ++L) l = h[f], (v = document.createElement("div")).className = "odometer-value", v.innerHTML = l, this.ribbons[p].appendChild(v), f === h.length - 1 && r(v, "odometer-last-value"), 0 === f && r(v, "odometer-first-value");
    ...
    }(), i.options = null != (w = window.odometerOptions) ? w : {}, setTimeout((function () {
        var t, e, n, o, r;
        if (window.odometerOptions) {
            for (t in r = [], o = window.odometerOptions) e = o[t], r.push(null != (n = i.options)[t] ? (n = i.options)[t] : n[t] = e);
            return r
        }
    }), 0), i.init = function () {
        var t, e, n, o, r, s;
        if (null != document.querySelectorAll) {
            for (s = [], n = 0, o = (e = document.querySelectorAll(i.options.selector || ".odometer")).length; o > n; n++) t = e[n], s.push(t.odometer = new i({
                el: t,
                value: null != (r = t.innerText) ? r : t.textContent
            }));
            return s
        }
    }, null != (null != (M = document.documentElement) ? M.doScroll : void 0) && null != document.createEventObject ? (v = document.onreadystatechange, document.onreadystatechange = function () {
        return "complete" === document.readyState && !1 !== i.options.auto && i.init(), null != v ? v.apply(this, arguments) : void 0
